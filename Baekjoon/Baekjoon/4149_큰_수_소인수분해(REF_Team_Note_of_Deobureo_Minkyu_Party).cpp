...
namespace miller_rabin {
	lint mul(lint x, lint y, lint mod) { return (__int128)x * y % mod; }	//VS환경에서는 __int128지원 안함. 64bit 쓸 경우 (10^9 + 7)^2 소인수분해가 안됨. 큰 수 자체가 안되는건가
